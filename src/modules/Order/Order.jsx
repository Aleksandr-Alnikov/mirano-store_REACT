                    ...
                    <>
                        ...
                        <form className="order__form" id="order">
                            ...
                            <fieldset className="order__fieldset">
                                ...
                                <div className="order__input-group">
                                    <input className="order__input" type="text" name="name-recipient"
                                           placeholder="Имя"/>
                                    <input className="order__input" type="text" name="phone-recipient"
                            ...
                            <fieldset className="order__fieldset">
                                ...
                                <div className="order__input-group">
                                    ...
                                    <input className="order__input order__input_min" type="text" name="house"
                                           placeholder="Дом"/>
                                    <input className="order__input order__input_min" type="text" name="apartment"
                        ...
                        <div className="order__footer">
                            ...
                            <button className="order__button"
                                    type="submit" form="order">Заказать
                            </button>
                        </div>
                    </>
                )};
            </div>
                <button className="order__close" type="button">x</button>
        </div>
    );
};